      ...
      <div className="w-full max-w-md relative z-10">
        <div className="flex items-center justify-between mb-8">
          ...
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-gray-900">CollaboAI</span>
          </Link>
        </div>

        <Card className="backdrop-blur-sm bg-white/80 border-white/20 shadow-2xl animate-in fade-in-0 slide-in-from-bottom-4 duration-700">
          <CardHeader className="text-center space-y-2">
            <CardTitle className="text-2xl font-bold text-gray-900">Welcome back</CardTitle>
            <CardDescription className="text-gray-600">Sign in to continue collaborating with AI</CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <Button
                type="submit"
                disabled={isLoading}
                className="w-full bg-blue-600 hover:bg-blue-700 text-white transition-all duration-200 hover:scale-[1.02] hover:shadow-lg disabled:scale-100"
              >
                {isLoading ? (
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button
                variant="outline"
                className="transition-all duration-200 hover:scale-[1.02] hover:shadow-md bg-transparent"
              >
